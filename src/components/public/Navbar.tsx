...
export function Navbar({ actions }: NavbarProps) {
  ...
  return (
    <header className="fixed top-0 start-0 end-0 z-50 border-b border-gray-100 dark:border-gray-800 bg-white/85 dark:bg-gray-950/85 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 sm:gap-3">
          ...
          <button
            ...
            className="p-2.5 lg:p-2 rounded-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          ...
          <div ref={langRef} className="relative">
            <button
              ...
              className="flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors px-2.5 py-2.5 lg:py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
            >
            ...
            {langOpen && (
              <div className="absolute end-0 mt-1 w-36 rounded-lg border border-gray-200 dark:border-gray-700 py-1 shadow-lg bg-white dark:bg-gray-900">
                {languages.map((l) => (
                  <button
                    key={l.code}
                    onClick={() => {
                    ...
                    className={`w-full text-start px-3 py-2.5 lg:py-2 text-sm transition-colors ${
                      l.code === locale
          ...
          <button
            ...
            className="md:hidden p-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
